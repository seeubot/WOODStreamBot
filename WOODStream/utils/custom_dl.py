...
class ByteStreamer:
    ...
    async def generate_file_properties(self, db_id: str, multi_clients) -> Optional[FileId]:
        ...
        # Check if the FileId object has the file_size attribute, and if not, add it.
        # This is a defensive fix to prevent the AttributeError.
        if not hasattr(file_id, 'file_size'):
